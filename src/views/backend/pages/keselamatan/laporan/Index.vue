          ...
          >
            ...
            <template v-slot:[`item.aksi`]="{ value }">
              ...
              >
                ...
                <v-list>
                  <v-list-item
                    @click="setStatusTindakLanjut(value.id)"
                    v-show="page.actions.edit"
                  >
                    <v-list-item-title>
                      <v-icon :color="theme.color">mdi-access-point-check</v-icon> Set Status Tindak Lanjut
                    </v-list-item-title>
                  </v-list-item>
                  <v-divider></v-divider>
                  <v-list-item
...
export default {
  ...
  methods: {
    ...
    setStatusTindakLanjut: async function (val) {
      try {
        let {
